...
CREATE TABLE emp4( // 여기부터 확인해야 함
    eno VARCHAR2(4),
    ename VARCHAR2(50) CONSTRAINT emp4_ename_nu Not Null,
    gno VARCHAR2(13),
    sex VARCHAR2(3),
    CONSTRAINT emp4_eno_pk PRIMARY KEY(eno),
    CONSTRAINT emp4_gno_pk UNIQUE(gno),
    CONSTRAINT emp4_eno_ch CHECK(LENGTH(eno)+13),
...
VALUES('1002', '임연아', '123456780123', '여')
...
gno(주민번호) 글자가 12글자일때
INSERT INTO emp4(eno,ename, gno, sex)
VALUES('1005', '이연아', '123456780123', 'M')
