...
INSERT INTO class VALUES('02', '연두새싹반');

INSERT INTO st VALUES('11', '노랑새싹반', '01');
INSERT INTO st VALUES('12', '노랑새싹반', '02');
INSERT INTO st VALUES('15', '노랑새싹반', '03');
...
ALTER TABLE st
ADD CONSTRAINT st_cno_fk FOREIGN KEY(cno) REFERENCES class(ncmo(cno)
